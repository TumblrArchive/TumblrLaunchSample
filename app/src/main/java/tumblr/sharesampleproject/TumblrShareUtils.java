...
public class TumblrShareUtils {
	 ...
	 * @param data
	 * 		the data Uri to open from within Tumblr. This should be a Uri created from the {@link DeepLinkCreator}.
	 */
	...
	/**
	 * Creates a deep link in the Tumblr application.
	 *
	 * @author brandon
	 */
	public static class DeepLinkCreator {
		/**
	...
	/**
	 * Builds intents that will share content into the Tumblr app.
	 *
	 * @author brandon
	 */
	public static class ShareIntentCreator {
		/**
		 * The package name for the Tumblr app.
		 */
